		...
		void(*reply_func)(unsigned char *data, unsigned int len))
{
    ...
    pms = (uint16_t)(4000.0f / kmh); //4000 - значение для колеса 14", подбирается индивидуально (больше диаметр - пропорционально больше значение),
	//окончательная подгонка спидометра к реальности - в vesctools по диаметру колеса и количеству магнитов (motor settings/aditional info/setup)
    if (pms > 0xFFFE) {
